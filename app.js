    ...
    content: {
        ...
        '2.3': {
            ...
            content: `
                ...
                <p>Ведомость на перемещение вместе с фото Упаковочного Листа (или Ведомостей ГМ) и описанием откуда и куда было перемещение, необходимо предоставить в группу <a href="#5.8" onclick="showContent('5.8')" style="color: #2563eb; text-decoration: none; font-weight: 600;">«ВЫДАЧА ТМЦ ПО ЗАЯВКАМ»</a>.</p>
        ...
        '3.1': {
            ...
            content: `
                ...
                <p>Разместить информацию о выдаче в группу <a href="#5.8" onclick="showContent('5.8')" style="color: #2563eb; text-decoration: none; font-weight: 600;">«ВЫДАЧА ТМЦ ПО ЗАЯВКАМ»</a>. Информация должна включать:</p>
