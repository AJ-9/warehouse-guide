...
const warehouseData = {
    ...
    content: {
        ...
        '2.2': {
            ...
            content: `
                <h3>Коды хранения</h3>
                <p>ТМЦ выгружаются и хранятся на площадках согласно кодам хранения. Информация по кодам хранения присутствует в Упаковочном Листе и в Ведомости Грузового Места (см. <a href="#4.4" onclick="showSection('4.4')" style="color: #2563eb; text-decoration: none; font-weight: 600;">Главу «Содержание Упаковочного Листа (УЛ)»</a> и <a href="#4.5" onclick="showSection('4.5')" style="color: #2563eb; text-decoration: none; font-weight: 600;">«Содержание Ведомости Грузового места»</a>).</p>
                ...
                <h4>Выгрузка XXX</h4>
                <p><strong>Выгрузка XXX при наличии места в крытых складах или контейнерах СТРОГО ЗАПРЕЩЕНА без согласования Руководителя склада либо его Заместителя.</strong></p>
                
                <h4>Выгрузка XXXX</h4>
                <p><strong>Выгрузка XXXX при наличии места в крытых отапливаемых складах СТРОГО ЗАПРЕЩЕНА без согласования Руководителя склада либо его Заместителя.</strong></p>
            `
        },
        '2.3': {
            ...
            content: `
                ...
                <p>Перед перемещением материала со склада необходимо убедиться в его наличии на складской площадке и доступности для проведения ПРР. Кладовщик должен заказать технику для проведения ПРР и транспортировки, учитывая габариты материала и место его расположения. Техника заказывается через диспетчеров.</p>
                
                <h3>После погрузки</h3>
                <p>После погрузки ТМЦ необходимо заполнить «Ведомость на перемещение и приемку» (см. <a href="#4.3" onclick="showSection('4.3')" style="color: #2563eb; text-decoration: none; font-weight: 600;">раздел 4.3</a>).</p>
                ...
                <p>Ведомость на перемещение вместе с фото Упаковочного Листа (или Ведомостей ГМ) и описанием откуда и куда было перемещение, необходимо предоставить в группу <a href="#5.8" onclick="showSection('5.8')" style="color: #2563eb; text-decoration: none; font-weight: 600;">«ВЫДАЧА ТМЦ ПО ЗАЯВКАМ»</a>.</p>
        ...
        '2.5': {
            ...
            content: `
                ...
                <p>Бывают случаи, когда ТС, приехавшее для выгрузки, перенаправляется на территорию завода для последующей сборки. В таких ситуациях полевой сотрудник получает информацию от Диспетчеров, либо китайские коллеги физически приезжают на склад и сообщают об этом.</p>
        ...
        '3.0': {
            ...
            content: `
                ...
                <p>Выдача материала в монтаж проводится по Заявкам на Выдачу (См. <a href="#4.7" onclick="showSection('4.7')" style="color: #2563eb; text-decoration: none; font-weight: 600;">раздел 4.7 «Содержание Заявки на выдачу»</a>).</p>
        ...
        '3.1': {
            ...
            content: `
                ...
                <p>Заполнить Пропуск на вывоз (см. <a href="#4.8" onclick="showSection('4.8')" style="color: #2563eb; text-decoration: none; font-weight: 600;">раздел 4.8</a>).</p>
                
                <h4>8. Постинг информации о выдаче</h4>
                <p>Разместить информацию о выдаче в группу <a href="#5.8" onclick="showSection('5.8')" style="color: #2563eb; text-decoration: none; font-weight: 600;">«ВЫДАЧА ТМЦ ПО ЗАЯВКАМ»</a>. Информация должна включать:</p>
                ...
                <ul>
                    ...
                    <li>Фото взятых ТМЦ и их Упаковочного Листа/Ведомости ГМ/Shipping Mark/маркировки по каждому ГМ. Без этих фото Отдел Учета не может списать материал.</li>
                    ...
                    <li>Текстовые данные: Номер заявки, количество (и опционально наименование) выданных ГМ, номера отпущенных ГМ (при наличии), ФИО китайского коллеги, который производил выдачу (при наличии).</li>
                </ul>
                
                <h3>Пример</h3>
                <div class="image-container">
                    <img src="images/image_4_4.png" alt="Пример постинга выдачи" style="max-width: 100%; height: auto; border-radius: 10px; margin: 10px 0;">
        ...
        '3.2': {
            ...
            content: `
                ...
                <p>В случае обнаружения несоответствий при пересчете (недостача, излишки, пересорт, порча/бой) необходимо вызвать представителя Бизнес-Тренда для совместного осмотра. После этого необходимо составить Акт Осмотра (см <a href="#3.3" onclick="showSection('3.3')" style="color: #2563eb; text-decoration: none; font-weight: 600;">раздел 3.3 «Составление Акта Осмотра»</a>). На ГМ с несоответствиями маркером написать с двух смежных сторон «Посчитано, составлен Акт». Также необходимо убедиться, что ГМ возможно идентифицировать (наклеен УЛ/Ведомость ГМ/ГМ промаркировано).</p>
                ...
                <p>Если по физике все сошлось, и в ГМ остался 41 болт, то можно постить выдачу в группу «Выдача ТМЦ по Заявкам». На ГМ маркером написать «Посчитано»</p>
                
                <p>Если по физике остатки ТМЦ не сошлись с тем, что должно остаться по системе 1С, то необходимо запостить выдачу в группу «Выдача ТМЦ по Заявкам», а затем составить Акт Осмотра. На ГМ маркером написать «Посчитано. Составлен Акт»</p>
                ...
                <p><strong>Если ГМ вскрывается повторно и при первом вскрытии остатки были сверены</strong> (На ГМ написано «Посчитано»), то следует произвести выдачу в общем порядке с последующим постингом в группу «Выдача ТМЦ по Заявкам».</p>
            `
        },
        '3.3': {
            ...
            content: `
                ...
                <p>Акт Осмотра составляется, если при <strong>частичной выдаче</strong> обнаружена недостача, излишки, пересорт или порча/бой материала. Это касается как ТМЦ, прошедших ВК, так и не прошедших.</p>
                
                <h3>Действия при обнаружении несоответствий</h3>
                <p>При обнаружении несоответствий необходимо вызвать сотрудника Бизнес-Тренда для совместного осмотра ТМЦ.</p>
                
                <h3>Информация для постинга полевого сотрудника</h3>
                <p>При обнаружении несоответствий полевой сотрудник должен разместить в группу <a href="https://max.ru/join/LKsu74vfEKoJCa5SdggIfbG0-OAUj_Xy_TSxqcS2Q00" target="_blank" style="color: #2563eb; text-decoration: none; font-weight: 600;">Оперуполномоченные</a> следующую информацию:</p>
        ...
        '4.1': {
            ...
            content: `
                ...
                <div class="image-container">
                    <img src="images/image_12_1.png" alt="Пример пункта 3 ТН" style="max-width: 100%; height: auto; border-radius: 10px; margin: 10px 0;">
        ...
        '4.3': {
            ...
            content: `
                ...
                <ol>
                    <li><strong>Перемещение ТМЦ между складами:</strong> например, с С23-1 в Ангар 08-07, или с С23-2 в С23-5, или с Ангара 08-01 в Ангар 07-10.</li>
                    <li><strong>Перемещение ТМЦ по складу:</strong> например, перемещение в рамках одного Ангара 08-01, или в рамках склада С23-1.</li>
                ...
                <h4>а) Вид перемещения</h4>
                <p>Вид перемещения материала должен быть подчеркнут.</p>
                
                <h4>б) Дата перемещения</h4>
                <p>Указать дату проведения перемещения.</p>
                
                <h4>в) Склад отправитель</h4>
                <p>Указать склад отправитель, если перемещение между складами.</p>
                
                <h4>г) Склад получатель</h4>
                <p>Указать склад получатель, который является тем же складом, где происходит перемещение, или где принимается материал.</p>
                
                <h4>д) ФИО ответственного лица</h4>
                <p>Указать Фамилию И.О. ответственного лица.</p>
                
                <h4>е) Номера грузовых мест</h4>
                <p>Указать номера ГМ.</p>
                
                <h4>ж) Наименование и характеристики ТМЦ</h4>
                ...
                <h4>з) Ячейка/Лот хранения</h4>
                <p>Указать ячейку/лот хранения, где принимается материал.</p>
                
                <h4>и) Номер упаковочного листа, ТН, примечание</h4>
                ...
                <div class="image-container">
                    <img src="images/image_13_2.png" alt="Пример ведомости на перемещение" style="max-width: 100%; height: auto; border-radius: 10px; margin: 10px 0;">
        ...
        '4.4': {
            ...
            content: `
                ...
                <p>Упаковочный лист содержит список грузовых мест, их общее содержимое, массогабаритные характеристики, коды хранения и т.д. Упаковочный лист должен быть приложен к отгрузочному документу (ТН). Если в отгрузочном документе указано только количество грузовых мест, а не их номера, но присутствует номер упаковочного листа, то полученные грузовые места (которые должны иметь прикрепленные упаковочные листы и ведомости грузовых мест) должны быть сверены с содержимым упаковочного листа.</p>
                
                <h3>Содержимое упаковочного листа</h3>
                
                <h4>а) Номер Упаковочного Листа</h4>
                <p>Должен совпадать с пунктом 4 отгрузочного документа («Сопроводительные документы»).</p>
                
                <h4>б) Уникальный Идентификатор Грузового Места (УИГМ)</h4>
                <p>Количество УИГМ должно совпадать с физическим количеством грузовых мест. В идеале одна паллета равна одному грузовому месту. Также один ТС равен одной ТН равен одному УЛ. УИГМ может содержать одну или много номенклатурных позиций, а каждая номенклатурная позиция, в свою очередь, может присутствовать в большом количестве.</p>
                
                <h4>в) Таговый номер</h4>
                <p>Материалам присваивается таговый номер. В некоторых ситуациях присваивается титул для закупленного материала, что актуально для трубной продукции, например. Один таговый номер может относиться к многим номенклатурным позициям. Например, «TAG-001» для буровой установки, где запасные части как ротор, анкерные болты, измерительные приборы, долота также имеют «TAG-001». В таких случаях материал должен идентифицироваться по его Наименованию и Артикулу поставщика. Для металлоконструкций таговый номер индивидуальный и используется в схеме сборки. Например, балка с таговым номером EPS-0000-12200-11-4303-111-87-149-001 присутствует на объекте в единственном экземпляре.</p>
                ...
                <h4>г) Артикул поставщика</h4>
                <p>Актуален, когда идентификация по TAG номеру и описанию материала невозможна.</p>
                
                <h4>д) Наименование товара и его характеристика</h4>
                <p>Основной маркер для идентификации содержимого.</p>
                
                <h4>е) Единица измерения по данной номенклатурной позиции</h4>
        ...
        '4.5': {
            ...
            content: `
                ...
                <h4>б) Габаритные размеры Грузового Места</h4>
                <p>Размеры грузового места в сантиметрах (длина x ширина x высота).</p>
                
                <h4>в) Код хранения</h4>
                <p>См. <a href="#chapter2" onclick="showChapter('chapter2')" style="color: #2563eb; text-decoration: none; font-weight: 600;">главу «Хранение»</a>.</p>
                
                <h4>г) Индекс штабелирования</h4>
                <p>Если указаны кг, то это количество кг, которые допустимо поставить на ГМ сверху. Если указана цифра (0, 1, 2), то это количество ГМ с таким же весом, которые допустимо поставить на ГМ сверху. При индексе штабелирования 0 ставить что-либо на ГМ сверху не рекомендуется.</p>
                
                <h4>д) Таговый номер</h4>
                <p>Материалам присваивается таговый номер. В некоторых ситуациях присваивается титул для закупленного материала, что актуально для трубной продукции, например. Один таговый номер может относиться к многим номенклатурным позициям. В таких случаях материал должен идентифицироваться по его Наименованию и Артикулу поставщика.</p>
                
                <h4>е) Артикул поставщика</h4>
                <p>Актуален, когда идентификация по таговому номеру и описанию материала невозможна.</p>
                
                <h4>ж) Уникальный Идентификатор Грузового Места (УИГМ)</h4>
        ...
        '4.6': {
            ...
            content: `
                ...
                <h4>з) Индекс Штабелирования</h4>
                <p>Информация о возможности штабелирования.</p>
                
                <h4>и) Код хранения</h4>
        ...
        '4.7': {
            ...
            content: `
                ...
                <h4>а) Номер заявки и дата</h4>
                <p>Дата в системе 1С может отличаться от даты подтверждения.</p>
                
                <h4>б) Титул и заявитель</h4>
                <p>Наименование заявителя должно совпадать с наименованием организации на бейдже.</p>
                
                <h4>в) TAG номер</h4>
                <p>Материалам присваивается TAG номер. В некоторых ситуациях присваивается титул для закупленного материала, что актуально для трубной продукции, например. Один TAG номер может относиться к многим номенклатурным позициям. В таких случаях материал должен идентифицироваться по его Наименованию и Артикулу поставщика.</p>
                
                <h4>г) Артикул (Артикул поставщика)</h4>
                <p>Актуален, когда идентификация по TAG номеру и наименованию материала невозможна.</p>
                
                <h4>д) Наименование материала</h4>
                <p>Подробное описание материала и его характеристики.</p>
                
                <h4>е) Единица измерения</h4>
                ...
                <h4>ж) Запрашиваемое и согласованное количество</h4>
        ...
        '4.8': {
            ...
            content: `
                ...
                <h4>а) Номер пропуска на вывоз материала</h4>
                ...
                <h4>д) Номер Заявки на Выдачу</h4>
                ...
                <h4>ж) Номер позиции в заявке</h4>
