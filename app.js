        ...
        '5.2': {
            ...
            content: `
                ...
                <div style="margin: 20px 0; padding: 15px; background-color: #f8f9fa; border-radius: 8px; border-left: 4px solid #2563eb;">
                    <p><strong>💡 Совет:</strong> Для получения подробной информации о назначении и правилах использования каждой группы, перейдите в раздел <a href="javascript:void(0);" onclick="showChapter('5.1')" style="color: #2563eb; text-decoration: none; font-weight: 600;">5.1 "Детальное описание информационных групп"</a>.</p>
                </div>
            `
        },
