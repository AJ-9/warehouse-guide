    ...
    content: {
        ...
        '4.9': {
            ...
            content: `
                ...
                <h4>a) Площадка, на которой проводится инвентаризация</h4>
                <p>Указать название площадки, где проводится инвентаризация.</p>
                
                <h4>b) Номер ГМ</h4>
                <p>Указать номер грузового места.</p>
                
                <h4>c) Бин, Ячейка на которой производится пересчет</h4>
                <p>Указать бин и ячейку, где производится пересчет материала.</p>
                ...
                <div class="image-container" style="margin: 15px 0;">
                    <img src="images/4.9.png" alt="Пример инвентаризационного листа" style="max-width: 100%; height: auto; border-radius: 10px; margin: 10px 0;">
                    <p><em>Пример инвентаризационного листа</em></p>
                </div>
            `
        },
        ...
        '5.2': {
            ...
            content: `
                ...
                <div style="margin: 20px 0; padding: 15px; background-color: #f8f9fa; border-radius: 8px; border-left: 4px solid #2563eb;">
                    <p><strong>💡 Совет:</strong> Для получения подробной информации о назначении и правилах использования каждой группы, перейдите в раздел <a href="javascript:void(0);" onclick="showChapter('chapter5')" style="color: #2563eb; text-decoration: none; font-weight: 600;">5.1 "Детальное описание информационных групп"</a>.</p>
                </div>
            `
        },
