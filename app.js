    ...
    content: {
        ...
        '4.8': {
            ...
            content: `
                ...
                <p>Номер пропуска на вывоз материала. Заполняется самостоятельно с указанием локации выдачи. Например 2025.09.26-1/C23-1, Где 2025.09.26 это дата, 1 - это порядковый номер выдачи, выданной с этой локации за день, С23-1 – локация, с которой произведена выдача. Пропуск заполняется на каждое ТС, уходящее с площадки, уходящее с площадки с грузом по Заявке на Выдачу.</p>
