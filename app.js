    ...
    content: {
        ...
        '2.1': {
            ...
            content: `
                ...
                <p>Если на складской площадке замечен материал без маркировки, ее следует запросить через группу «Потеряшки», распечатать и промаркировать материал. Допустимо промаркировать материал маркером – написать номер ГМ.</p>
        ...
        '2.2': {
            ...
            content: `
                <h3>Коды хранения</h3>
                <p>ТМЦ выгружаются и хранятся на площадках согласно кодам хранения. Информация по кодам хранения присутствует в Упаковочном Листе и в Ведомости Грузового Места (см. Главу «Содержание Упаковочного Листа и Ведомости Грузового места»).</p>
        ...
        '2.3': {
            ...
            content: `
                ...
                <p>После погрузки ТМЦ необходимо заполнить «Ведомость на перемещение и приемку» (см. Главу 4, раздел 4.3).</p>
                ...
                <p>Ведомость на перемещение вместе с фото Упаковочного Листа (или Ведомостей ГМ) и описанием откуда и куда было перемещение, необходимо предоставить в группу «ВЫДАЧА ТМЦ ПО ЗАЯВКАМ».</p>
        ...
        '3.0': {
            ...
            content: `
                ...
                <p>Выдача материала в монтаж проводится по Заявкам на Выдачу (См. раздел 4.7 «Содержание Заявки на выдачу»).</p>
        ...
        '3.1': {
            ...
            content: `
                ...
                <p>Заполнить Пропуск на вывоз (см. раздел 4.8).</p>
                
                <h4>8. Постинг информации о выдаче</h4>
                <p>Разместить информацию о выдаче в группу «ВЫДАЧА ТМЦ ПО ЗАЯВКАМ». Информация должна включать:</p>
